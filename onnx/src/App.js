...
const DISEASE_INFO = {
  Bronchiectasis: { color: '#e07b39', desc: 'Widening/scarring of bronchial tubes' },
  Bronchiolitis:  { color: '#d45f88', desc: 'Small airway inflammation' },
  COPD:           { color: '#c0392b', desc: 'Chronic Obstructive Pulmonary Disease' },
  Healthy:        { color: '#27ae60', desc: 'No respiratory disease detected' },
  Pneumonia:      { color: '#8e44ad', desc: 'Lung tissue infection/inflammation' },
  URTI:           { color: '#2980b9', desc: 'Upper Respiratory Tract Infection' },
};
...
export default function App() {
  ...
  useEffect(() => {
    ...
    loadModel(MODEL_URL)
      ...
      .catch(() => setStatusMsg('Place respiratory_knn.onnx in /public/'));
  }, []);
    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <section className="info-row">
          <InfoCard title="Signal Processing">
